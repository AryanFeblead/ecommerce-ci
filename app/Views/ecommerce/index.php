                        ...
                        <div id="tab-1" class="tab-pane fade show p-0 active">
                            <div class="row g-4">
                                <div class="col-lg-12">
                                    <div class="row g-4">
                                        <?php
                                                $select = mysqli_query($conn, "SELECT * FROM prod_tbl LIMIT 4");
                            ...
                            <div class="row g-4">
                                <div class="col-lg-12">
                                    ...
                                    <?php
                                        ...
                                        $select = mysqli_query($conn, "SELECT * FROM prod_tbl WHERE prod_category='Vegetable' LIMIT 4");
                                        if (mysqli_num_rows($select) > 0) {
                                            while ($row = mysqli_fetch_assoc($select)) {
                                                $fruit_display = '<div class="col-md-6 col-lg-4 col-xl-3">
                                                <a href="shop-detail.php?id='. $row['prod_id'] .'">
                            ...
                            <div class="row g-4">
                                <div class="col-lg-12">
                                    ...
                                    <?php
                                        ...
                                        $select = mysqli_query($conn, "SELECT * FROM prod_tbl WHERE prod_category='Fruit' LIMIT 4");
                                        if (mysqli_num_rows($select) > 0) {
                                            while ($row = mysqli_fetch_assoc($select)) {
                                                $fruit_display = '<div class="col-md-6 col-lg-4 col-xl-3">
                                                <a href="shop-detail.php?id='. $row['prod_id'] .'">
        ...
        <div class="container-fluid vesitable py-5">
            <div class="container py-5">
                ...
                <?php
                    ...
                    $select = mysqli_query($conn, "SELECT * FROM prod_tbl");
                    if (mysqli_num_rows($select) > 0) {
                        while ($row = mysqli_fetch_assoc($select)) {
