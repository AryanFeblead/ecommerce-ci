            ...
            <div class="container py-5">
                                    ...
                                    $display_cart = '<tr>
                                        <th scope="row">
                                            <div class="d-flex align-items-center">
                                                <img src="' . htmlspecialchars($item['prod_img']) . '" class="img-fluid me-5 rounded-circle" style="width: 80px; height: 80px;" alt="">
                                            </div>
                                        </th>
                                        <td>
                                        ...
                                        <td>
                                            <button class="btn btn-md rounded-circle bg-light border mt-4 del" data-item-id="' . htmlspecialchars($item['prod_id']) . '">
                ...
                <?php
                  if (isset($_SESSION['cart_item']) && !empty($_SESSION['cart_item'])) {
                    ...
                    $display_checkout = '<div class="row g-4 justify-content-end">
                    <div class="col-8"></div>
