                                ...
                                <tr>
                                    <th scope="row">
                                        <div class="d-flex align-items-center">
                                            <img src="<?= base_url('assets/mainDoc/' . $item['prod_img']); ?>" class="img-fluid me-5 rounded-circle" style="width: 80px; height: 80px;" alt="">
                                        </div>
                                    </th>
                                    <td>
                                        <p class="mb-0 mt-4">Awesome <?= htmlspecialchars($item['prod_name']); ?></p>
                                    </td>
                                    <td>
                                        <p class="mb-0 mt-4 prod-price"><?= htmlspecialchars($item['prod_price']); ?></p>
                                    </td>
                                    <td>
                                        <div class="input-group quantity mt-4" style="width: 100px;">
                                            ...
                                            <input type="text" class="form-control form-control-sm text-center border-0 item-quantity" value="<?= htmlspecialchars($item['prod_quantity']); ?>" min="1">
                                            <div class="input-group-btn">
                                    ...
                                    <td>
                                        <p class="mb-0 mt-4 prod-total"><?= htmlspecialchars($item['prod_total']); ?></p>
                                    </td>
                                    <td>
                                        <button class="btn btn-md rounded-circle bg-light border mt-4 dell" data-item-id="<?= htmlspecialchars($item['prod_id']); ?>">
            ...
            <div class="row g-4 justify-content-end">
                ...
                <div class="col-sm-8 col-md-7 col-lg-6 col-xl-4">
                    <div class="bg-light rounded">
                        ...
                        <a href="<?= site_url('checkout'); ?>" class="btn border-secondary rounded-pill px-4 py-3 text-primary text-uppercase mb-4 ms-4">Proceed Checkout</a>
                    </div>
                </div>
            </div>
